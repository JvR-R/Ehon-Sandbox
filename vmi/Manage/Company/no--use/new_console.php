...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (status === "success") {
        ...
        toastr.success(
            ...
            "<button style='margin-right: 8px; colour: black;' onclick=\"window.location.href='new_console.php'\">Add Another Console</button>" +
            "<button onclick=\"window.location.href='new_site.php'\">Create New Site</button>"
        );
    } 
