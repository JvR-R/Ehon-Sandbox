    ...
    <div class="dashboard-main-section">
        ...
        <div class="sidebar-spacer2"></div>
            ...
            <?php include('../../details/top_menu.php');?>
                <form id="Distributor_info" action="new_Distributor_sbmt.php" method="post" class="container-default w-container" style="padding-top: 24px; max-width: 960px;" autocomplete="off">
                    <!-- Division for input fields -->
                    <div class="mg-bottom-24px">
                        <div class="card pd-28px">                    
                            <h1 class="display-4 mg-bottom-4px">Distributor Information</h1>
                            <div class="grid-2-columns _1-82fr---1fr gap-0" style="grid-template-columns: 0.82fr 2fr; align-items: center;">
                                ...
                                <input class="input" type="text" style="margin-bottom: 3px" placeholder="Enter the Distributor Name" name="Client_name" required>                           
                                <label>Distributor Address:</label>
                                <input class="input" type="text" placeholder="Enter Distributor address" name="Client_address" required> 
                                <label>Distributor Email:</label>
                                <input class="input" type="email" placeholder="Enter Distributor contact email" name="Distributor_email" autocomplete="off" required>                     
                                <label>Distributor Phone:</label>
                                <input class="input" type="tel" placeholder="Enter Distributor phone number" name="Client_phone" required>
                            </div>
                            <br>
                            <br>
...
<script>
    document.getElementById('Distributor_info').addEventListener('submit', function(event) {
