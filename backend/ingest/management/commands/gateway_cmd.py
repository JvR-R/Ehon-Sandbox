# ingest/management/commands/gateway_cmd.py
"""
...
--------
# Firmware update
python manage.py gateway_cmd \
    --device 34742A \
    --cmd    firmware \
    --value  https://fw.ehon.com.au/v2.5.0.bin \
    --retain
...
python manage.py gateway_cmd \
    --device 34742A \
    --cmd    charts \
    --value  https://fw.ehon.com.au/34742A_charts.zip
"""
